...
const bourbon = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/whisky/american-whiskey/bourbon', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Bourbon page loaded successfully");
    } catch (error) {
        console.log("Error loading bourbon page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/whisky/american-whiskey/bourbon', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/whisky/american-whiskey/bourbon?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
