...
const vodka = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/spirits/vodka', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/vodka?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
