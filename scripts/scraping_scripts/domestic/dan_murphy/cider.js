...
const cider = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/cider/all', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Cider page loaded successfully");
    } catch (error) {
        console.log("Error loading cider page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/cider/all', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/cider/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
