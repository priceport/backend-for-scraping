...
const sake = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/sake', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Sake page loaded successfully");
    } catch (error) {
        console.log("Error loading sake page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/sake', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/sake?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
