...
const liqueurs = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/liqueurs', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Liqueurs page loaded successfully");
    } catch (error) {
        console.log("Error loading liqueurs page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/liqueurs', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/liqueurs?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
