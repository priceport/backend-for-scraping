...
const sake = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/spirits/sake', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/sake?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
