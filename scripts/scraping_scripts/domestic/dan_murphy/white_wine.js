...
const whiteWine = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/white-wine/all', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/white-wine/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
