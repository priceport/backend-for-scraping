...
const whisky = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/whisky/all', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/whisky/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
