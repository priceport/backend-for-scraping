...
const women_fragrance_set = async (start,end,browser)=>{
    let pageNo = start-1;
    const url = "https://www.heinemann.com.au/en/ool/perfume-cologne/women-fragrances/sets/c/cat_4015/?q=%3Arelevance&page=";
    ...
    while(true){
        ...
        const [products,missing] = await page.evaluate(() => {
            ...
            productElements.forEach(product => {
                ...
                mapping_ref:null,
                unit:undefined,
                subcategory:'women_fragrance_set',
                img,
                isMultibuy
                });
        ...
        if(missing > 5) {
            await insertScrapingError("More than 5 entries missing for heinemann_goldcoast - women_fragrance_set: "+pageNo,"scraping_missing");
        }
        ...
        pageNo+=1;
            ...
            logError(err);
            try{
                await insertScrapingError("Error in heinemann_goldcoast - women_fragrance_set: "+err.message,"scraping_trycatch");
              }catch(err){
                  console.log(err);
              }
            await page.close();
...
module.exports = women_fragrance_set;