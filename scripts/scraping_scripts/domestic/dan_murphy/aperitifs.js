...
const aperitifs = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/aperitifs', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Aperitifs page loaded successfully");
    } catch (error) {
        console.log("Error loading aperitifs page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/aperitifs', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/aperitifs?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
