    ...
    while(iterator<data?.length){
        ...
        try{
            ...
            if(product.rowCount==0){
                ...
                await pool.query(`insert into price(product_id,date,price,website,price_per_unit) values($1, current_date, $2,$3,$4) returning *`,[product?.rows[0]?.id,price[0].price,"aelia_auckland",price_per_unit]);
