...
const brandyCognac = async () => {
    ...
    try {
        ...
        console.log("Error loading brandy cognac page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/brandy-cognac', { waitUntil: 'domcontentloaded', timeout: 60000 });
