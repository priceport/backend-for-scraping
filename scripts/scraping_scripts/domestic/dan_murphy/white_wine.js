...
const whiteWine = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/white-wine/all', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("White wine page loaded successfully");
    } catch (error) {
        console.log("Error loading white wine page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/white-wine/all', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/white-wine/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
