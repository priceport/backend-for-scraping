...
const rum = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/spirits/rum', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/rum?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
