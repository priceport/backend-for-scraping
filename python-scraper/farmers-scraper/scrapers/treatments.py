...
Standalone scraper for treatments category
"""
...
def scrape_treatments(start_page=1, end_page=1):
    """Scrape treatments products"""
    scraper = BaseFarmersScraper(
        category_name='treatments',
        base_url=CATEGORY_URLS['treatments'],
...
if __name__ == "__main__":
    ...
    products = scrape_treatments(start, end)
