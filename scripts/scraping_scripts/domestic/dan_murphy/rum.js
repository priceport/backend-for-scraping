...
const rum = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/rum', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Rum page loaded successfully");
    } catch (error) {
        console.log("Error loading rum page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/rum', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/rum?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
