...
const lollies = async (start,end,browser)=>{
    let pageNo = start;
    const url = 'https://www.aucklanddutyfree.co.nz/confectionery/lollies.html?p=';
    ...
    while(true){
        ...
        if(missing > 5) {
          await insertScrapingError("More than 5 entries missing for aelia_auckland - lollies: "+pageNo,"scraping_missing");
        }
