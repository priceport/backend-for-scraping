...
const face = require("../scripts/scraping_scripts/domestic/lifepharmacy/face");
const eyes = require("../scripts/scraping_scripts/domestic/lifepharmacy/eyes");
const lips = require("../scripts/scraping_scripts/domestic/lifepharmacy/lips");
const nails = require("../scripts/scraping_scripts/domestic/lifepharmacy/nails");
const make_up_sets = require("../scripts/scraping_scripts/domestic/lifepharmacy/make_up_sets");
const make_up_accessories = require("../scripts/scraping_scripts/domestic/lifepharmacy/make_up_accessories");
const moisturisers = require("../scripts/scraping_scripts/domestic/lifepharmacy/moisturisers");
const cleansers_scrubs = require("../scripts/scraping_scripts/domestic/lifepharmacy/cleansers_scrubs");
const toners = require("../scripts/scraping_scripts/domestic/lifepharmacy/toners");
const serums_treatments = require("../scripts/scraping_scripts/domestic/lifepharmacy/serums_treatments");
const eye_treatments = require("../scripts/scraping_scripts/domestic/lifepharmacy/eye_treatments");
const masks_peels = require("../scripts/scraping_scripts/domestic/lifepharmacy/masks_peels");
const medicated_skincare = require("../scripts/scraping_scripts/domestic/lifepharmacy/medicated_skincare");
const lip_care = require("../scripts/scraping_scripts/domestic/lifepharmacy/lip_care");
const skincare_gift_sets = require("../scripts/scraping_scripts/domestic/lifepharmacy/skincare_gift_sets");
const skincare_supplements = require("../scripts/scraping_scripts/domestic/lifepharmacy/skincare_supplements");
