...
const champagneSparkling = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/champagne-sparkling/all', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/champagne-sparkling/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
