...
const baijiu = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/spirits/baijiu', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/baijiu?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
