...
const gin = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/gin', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Gin page loaded successfully");
    } catch (error) {
        console.log("Error loading gin page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/gin', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/gin?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
