const skin_care = require("../scripts/scraping_scripts/duty_free/ishopchangi/skin_care");
const makeup = require("../scripts/scraping_scripts/duty_free/ishopchangi/makeup");
const hair_care = require("../scripts/scraping_scripts/duty_free/ishopchangi/hair_care");
const fragrance = require("../scripts/scraping_scripts/duty_free/ishopchangi/fragrance");
const bath_and_beauty = require("../scripts/scraping_scripts/duty_free/ishopchangi/bath_and_beauty");
const computers_and_peripherals = require("../scripts/scraping_scripts/duty_free/ishopchangi/computers_and_peripherals");
const mobile_and_smart_devices = require("../scripts/scraping_scripts/duty_free/ishopchangi/mobile_and_smart_devices");
const audio_devices = require("../scripts/scraping_scripts/duty_free/ishopchangi/audio_devices");
const cameras_and_drones = require("../scripts/scraping_scripts/duty_free/ishopchangi/cameras_and_drones");
const snacks_and_sweets = require("../scripts/scraping_scripts/duty_free/ishopchangi/snacks_and_sweets");
const coffee_and_tea = require("../scripts/scraping_scripts/duty_free/ishopchangi/coffee_and_tea");
const health_food = require("../scripts/scraping_scripts/duty_free/ishopchangi/health_food");
const souvenir_food = require("../scripts/scraping_scripts/duty_free/ishopchangi/souvenir_food");
const food_staples = require("../scripts/scraping_scripts/duty_free/ishopchangi/food_staples");
const family_planning = require("../scripts/scraping_scripts/duty_free/ishopchangi/family_planning");
const personal_care = require("../scripts/scraping_scripts/duty_free/ishopchangi/personal_care");
const wellness_accessories = require("../scripts/scraping_scripts/duty_free/ishopchangi/wellness_accessories");
const health_supplements = require("../scripts/scraping_scripts/duty_free/ishopchangi/health_supplements");
const medical_supplies = require("../scripts/scraping_scripts/duty_free/ishopchangi/medical_supplies");
const medication = require("../scripts/scraping_scripts/duty_free/ishopchangi/medication");
const food_care = require("../scripts/scraping_scripts/duty_free/ishopchangi/food_care");
const womens_fashion_bags = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_fashion_bags");
const womens_small_leather_goods = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_small_leather_goods");
const womens_fashion_watches = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_fashion_watches");
const womens_fashion_jewellery = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_fashion_jewellery");
const womens_fashion_accessories = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_fashion_accessories");
const womens_fashion_shoes = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_fashion_shoes");
const womens_apparels = require("../scripts/scraping_scripts/duty_free/ishopchangi/womens_apparels");
const mens_fashion_bags = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_fashion_bags");
const mens_small_leather_goods = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_small_leather_goods");
const mens_fashion_watches = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_fashion_watches");
const mens_fashion_jewellery = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_fashion_jewellery");
const mens_fashion_accessories = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_fashion_accessories");
const mens_fashion_shoes = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_fashion_shoes");
const mens_apparels = require("../scripts/scraping_scripts/duty_free/ishopchangi/mens_apparels");
const kitchen_and_dining = require("../scripts/scraping_scripts/duty_free/ishopchangi/kitchen_and_dining");
const personal_care_home_and_living = require("../scripts/scraping_scripts/duty_free/ishopchangi/personal_care_home_and_living");
const beauty_tools = require("../scripts/scraping_scripts/duty_free/ishopchangi/beauty_tools");
const wellness_and_health_devices = require("../scripts/scraping_scripts/duty_free/ishopchangi/wellness_and_health_devices");
const household_essentials = require("../scripts/scraping_scripts/duty_free/ishopchangi/household_essentials");
const babies_and_kids_fashion = require("../scripts/scraping_scripts/duty_free/ishopchangi/babies_and_kids_fashion");
const baby_gears = require("../scripts/scraping_scripts/duty_free/ishopchangi/baby_gears");
const bath = require("../scripts/scraping_scripts/duty_free/ishopchangi/bath");
const feeding_and_nursing = require("../scripts/scraping_scripts/duty_free/ishopchangi/feeding_and_nursing");
const nursery = require("../scripts/scraping_scripts/duty_free/ishopchangi/nursery");
const toys_and_games = require("../scripts/scraping_scripts/duty_free/ishopchangi/toys_and_games");
const souvenirs_fashion = require("../scripts/scraping_scripts/duty_free/ishopchangi/souvenirs_fashion");
const souvenirs_collectibles = require("../scripts/scraping_scripts/duty_free/ishopchangi/souvenirs_collectibles");
const luggages = require("../scripts/scraping_scripts/duty_free/ishopchangi/luggages");
const travel_bags = require("../scripts/scraping_scripts/duty_free/ishopchangi/travel_bags");
const electronics_travel = require("../scripts/scraping_scripts/duty_free/ishopchangi/electronics_travel");
const travel_essentials = require("../scripts/scraping_scripts/duty_free/ishopchangi/travel_essentials");
const spirits_single_malt = require("../scripts/scraping_scripts/duty_free/ishopchangi/spirits_single_malt");
const american_whiskey = require("../scripts/scraping_scripts/duty_free/ishopchangi/american_whiskey");
const scotch_blended_whiskey = require("../scripts/scraping_scripts/duty_free/ishopchangi/scotch_blended_whiskey");
const japanese_whiskey = require("../scripts/scraping_scripts/duty_free/ishopchangi/japanese_whiskey");
const tequila = require("../scripts/scraping_scripts/duty_free/ishopchangi/tequila");
const vodka = require("../scripts/scraping_scripts/duty_free/ishopchangi/vodka");
const rum = require("../scripts/scraping_scripts/duty_free/ishopchangi/rum");
const baijiu = require("../scripts/scraping_scripts/duty_free/ishopchangi/baijiu");
const gin = require("../scripts/scraping_scripts/duty_free/ishopchangi/gin");
const cognac = require("../scripts/scraping_scripts/duty_free/ishopchangi/cognac");
const brandy = require("../scripts/scraping_scripts/duty_free/ishopchangi/brandy");
const stout = require("../scripts/scraping_scripts/duty_free/ishopchangi/stout");
const craft_beer = require("../scripts/scraping_scripts/duty_free/ishopchangi/craft_beer");
const red_wines = require("../scripts/scraping_scripts/duty_free/ishopchangi/red_wines");
const white_wines = require("../scripts/scraping_scripts/duty_free/ishopchangi/white_wines");
const sparkling_wine = require("../scripts/scraping_scripts/duty_free/ishopchangi/sparkling_wine");
const champagnes = require("../scripts/scraping_scripts/duty_free/ishopchangi/champagnes");
...
const scrapeIshopChangi = async (start,end,state,browser) =>{
    ...
    // Travel and Services categories
    if(!state.ishopchangi.luggages)
        try{
            luggagesData = await luggages(start,end,browser);
            console.log(`${luggagesData?.length} data items scraped for luggages`);
        }
        catch(err){
            console.log("There was an error while scraping luggages");
            logError(err);
        }

    if(!state.ishopchangi.luggages && luggagesData?.length==0)
        try{
            luggagesData = await luggages(start,end,browser);
            console.log(`${luggagesData?.length} data items scraped for luggages`);
            if(luggagesData?.length==0){
                state.ishopchangi.luggages = true;
            }
        }
        catch(err){
            console.log("There was an error while scraping luggages");
    ...
    if(!state.ishopchangi.travel_bags)
        try{
            travelBagsData = await travel_bags(start,end,browser);
            console.log(`${travelBagsData?.length} data items scraped for travel bags`);
        }
        catch(err){
            console.log("There was an error while scraping travel bags");
            logError(err);
        }

    if(!state.ishopchangi.travel_bags && travelBagsData?.length==0)
        try{
            travelBagsData = await travel_bags(start,end,browser);
            console.log(`${travelBagsData?.length} data items scraped for travel bags`);
            if(travelBagsData?.length==0){
                state.ishopchangi.travel_bags = true;
            }
        }
        catch(err){
            console.log("There was an error while scraping travel bags");
    ...
    if(!state.ishopchangi.electronics_travel)
        try{
            electronicsTravelData = await electronics_travel(start,end,browser);
            console.log(`${electronicsTravelData?.length} data items scraped for electronics travel`);
        }
        catch(err){
            console.log("There was an error while scraping electronics travel");
            logError(err);
        }

    if(!state.ishopchangi.electronics_travel && electronicsTravelData?.length==0)
        try{
            electronicsTravelData = await electronics_travel(start,end,browser);
            console.log(`${electronicsTravelData?.length} data items scraped for electronics travel`);
            if(electronicsTravelData?.length==0){
                state.ishopchangi.electronics_travel = true;
            }
        }
        catch(err){
            console.log("There was an error while scraping electronics travel");
    ...
    if(!state.ishopchangi.travel_essentials)
        try{
            travelEssentialsData = await travel_essentials(start,end,browser);
            console.log(`${travelEssentialsData?.length} data items scraped for travel essentials`);
        }
        catch(err){
            console.log("There was an error while scraping travel essentials");
            logError(err);
        }

    if(!state.ishopchangi.travel_essentials && travelEssentialsData?.length==0)
        try{
            travelEssentialsData = await travel_essentials(start,end,browser);
            console.log(`${travelEssentialsData?.length} data items scraped for travel essentials`);
            if(travelEssentialsData?.length==0){
                state.ishopchangi.travel_essentials = true;
            }
        }
        catch(err){
            console.log("There was an error while scraping travel essentials");
