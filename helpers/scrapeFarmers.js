...
const scrapeFarmers = async (start,end,state,browser) =>{
    ...
    let faceData = [],makeupBagData = [], lipsData = [], eyesData = [], toolsData = [], tools2Data = [], womensPerfumeData = [],menAftershaveData=[],deodorantData=[],moisturiserData=[],exfoliatorsData=[],cleansersData=[],tonersData=[],treatmentsData=[],eyeCreamData=[],groomingData=[],nailToolsData=[],nailPolishData=[],bodyCareData=[],footCareData=[],bathCareData=[],sunCareData=[],hairCareData=[],hairColorData=[],hairAccesoriesData=[], wSkincareData=[], collagensData=[];
    ...
    //merge data
    faceData = [...faceData,...makeupBagData, ...lipsData, ...eyesData, ...toolsData, ...tools2Data, ...womensPerfumeData,...menAftershaveData,...deodorantData,...moisturiserData,...exfoliatorsData,...cleansersData,...tonersData,...treatmentsData,...eyeCreamData,...groomingData,...nailToolsData,...nailPolishData,...bodyCareData,...footCareData,...bathCareData,...sunCareData,...hairCareData,...hairColorData,...hairAccesoriesData, ...wSkincareData, ...collagensData];

    //process data
    try{
        faceData = await processDataForBeauty(faceData);
        console.log(`${faceData?.length} data items proccessed`);
    }catch(err){
