...
const sparklingChampagne = async (start, end, browser) => {
    let pageNo = start;
    const url = 'https://www.aeliadutyfree.com.au/adelaide/wine/sparkling-champagne.html?p=';
    ...
    try {
        ...
        while(true) {
            ...
            const [products, missing] = await page.evaluate(() => {
                ...
                productElements.forEach(product => {
                    ...
                    productList.push({ 
                        ...
                        category: 'liquor',
                        source: {
                            website_base: "https://www.aeliadutyfree.com.au/adelaide",
                            location: "adelaide",
                            tag: "duty-free"
                        }, 
                        date: Date.now(),
                        ...
                        mapping_ref: null,
                        unit: undefined,
                        subcategory: 'sparkling_champagne',
                        img
                    });
                });
            ...
            if(missing > 5) {
                await insertScrapingError("More than 5 entries missing for aelia_adelaide - sparkling champagne: " + pageNo, "scraping_missing");
            }
        ...
        logError(err);
        try {
            await insertScrapingError("Error in aelia_adelaide - sparkling champagne: " + err.message, "scraping_trycatch");
        } catch(err) {
            console.log(err);
        }
        await page.close();
...
module.exports = sparklingChampagne; 