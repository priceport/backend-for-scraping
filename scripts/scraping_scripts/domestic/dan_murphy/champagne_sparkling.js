...
const champagneSparkling = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/champagne-sparkling/all', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Champagne sparkling page loaded successfully");
    } catch (error) {
        console.log("Error loading champagne sparkling page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/champagne-sparkling/all', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/champagne-sparkling/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
