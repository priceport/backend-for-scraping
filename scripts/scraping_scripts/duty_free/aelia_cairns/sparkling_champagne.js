...
const sparkling_champagne = async (start, end, browser) => {
    let pageNo = start;
    const url = 'https://www.aeliadutyfree.com.au/cairns/wine/sparkling-champagne.html?p=';
    ...
    try {
        ...
        while(true) {
            ...
            const [products, missing] = await page.evaluate(() => {
                ...
                productElements.forEach(product => {
                    ...
                    productList.push({ 
                        ...
                        category: 'liquor',
                        source: {
                            website_base: "https://www.aeliadutyfree.com.au/cairns",
                            location: "cairns",
                            tag: "duty-free"
                        }, 
                        date: Date.now(),
            ...
            if(missing > 5) {
                await insertScrapingError("More than 5 entries missing for aelia_cairns - sparkling_champagne: " + pageNo, "scraping_missing");
            }
        ...
        logError(err);
        try {
            await insertScrapingError("Error in aelia_cairns - sparkling_champagne: " + err.message, "scraping_trycatch");
        } catch(err) {
            console.log(err);
        }
        await page.close();
...
module.exports = sparkling_champagne; 