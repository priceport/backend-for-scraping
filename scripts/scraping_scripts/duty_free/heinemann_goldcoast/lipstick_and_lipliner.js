...
const lipstick_and_lipliner = async (start,end,browser)=>{
    let pageNo = start-1;
    const url = "https://www.heinemann.com.au/en/ool/make-up/lips/lipstick-lipliner/c/cat_3021/?q=%3Arelevance&page=";
    ...
    while(true){
        ...
        const [products,missing] = await page.evaluate(() => {
            ...
            productElements.forEach(product => {
                ...
                mapping_ref:null,
                unit:undefined,
                subcategory:'lipstick_and_lipliner',
                img,
                isMultibuy
                });
        ...
        if(missing > 5) {
            await insertScrapingError("More than 5 entries missing for heinemann_goldcoast - lipstick_and_lipliner: "+pageNo,"scraping_missing");
        }
        ...
        pageNo+=1;
            ...
            logError(err);
            try{
                await insertScrapingError("Error in heinemann_goldcoast - lipstick_and_lipliner: "+err.message,"scraping_trycatch");
              }catch(err){
                  console.log(err);
              }
            await page.close();
...
module.exports = lipstick_and_lipliner;