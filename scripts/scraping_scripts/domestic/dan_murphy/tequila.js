...
const tequila = async () => {
    ...
    try {
        await page.goto('https://www.danmurphys.com.au/spirits/tequila', { waitUntil: 'networkidle2', timeout: 60000 });
        console.log("Tequila page loaded successfully");
    } catch (error) {
        console.log("Error loading tequila page:", error.message);
        // Try with a more lenient wait condition
        try {
            await page.goto('https://www.danmurphys.com.au/spirits/tequila', { waitUntil: 'domcontentloaded', timeout: 60000 });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/spirits/tequila?page=1&sortBy=relevance', { waitUntil: 'networkidle2', timeout: 60000 });
