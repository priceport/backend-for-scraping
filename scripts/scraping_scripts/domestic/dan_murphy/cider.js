...
const cider = async () => {
    ...
    await page.goto('https://www.danmurphys.com.au/cider/all', { waitUntil: 'networkidle2' });
    ...
    if (pageContent.hasNoProducts || pageContent.hasLoading) {
        ...
        await page.goto('https://www.danmurphys.com.au/cider/all?page=1&sortBy=relevance', { waitUntil: 'networkidle2' });
