    ...
    for (const item of priceChanges) {
        try {
            ...
            const processedItem = {
                ...
                conversion_rate_nzd: item.conversion_rate_nzd,
                conversion_rate_aud: item.conversion_rate_aud,
                conversion_rate_sgd: item.conversion_rate_sgd,
                old_price: pastPrice?.price || null,
                old_conversion_rate_nzd: pastPrice?.conversion_rate_nzd,
                old_conversion_rate_aud: pastPrice?.conversion_rate_aud,
                old_conversion_rate_sgd: pastPrice?.conversion_rate_sgd,
